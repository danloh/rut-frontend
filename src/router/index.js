  ...
  routes: [
    ...
    { path: '/profile/:id',
      ...
      children: [
        ...
        { path: 'doing', name: 'DoingItems', component: createProfileItems('doing'), meta: {auth: true} },
        { path: 'todo', name: 'TodoItems', component: createProfileItems('todo'), meta: {auth: true} },
        { path: 'done', name: 'DoneItems', component: createProfileItems('done'), meta: {auth: true} },
