  ...
  routes: [
    ...
    { path: '/p/:id', component: Profile, meta: {auth: true},
      children: [
        ...
        { path: 'doing', name: 'Doings', component: createItemList('user', '2'), meta: {auth: true} },
        { path: 'done', name: 'Dones', component: createItemList('user', '3'), meta: {auth: true} },
      ] 
    },
    { path: '/updateuser/:id', name: 'UpdateUser', component: UpdateUser, meta: {auth: true} },
    { path: '/r/:slug', name: 'Rutview', component: RutView },
    { path: '/new', name: 'NewRut', component: NewRut, meta: {auth: true} },
    { path: '/update/r/:slug', name: 'UpdateRut', component: UpdateRut, meta: {auth: true} },
    { path: '/collect/:slug', name: 'AddItem', component: AddItem, meta: {auth: true} },
    { path: '/submit', name: 'NewItem', component: NewItem, meta: {auth: true} },
    { path: '/item/:slug', name: 'Itemview', component: ItemView },
    { path: '/update/item/:slug', name: 'UpdateItem', component: UpdateItem, meta: {auth: true} },
