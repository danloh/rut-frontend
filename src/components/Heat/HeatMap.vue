...
export default {
  ...
  methods: {
    renderHeatMap () {
      ...
      let heatmap = calendarHeatmap.init().data(data).selector('.heatmap')
...
<style>
.heatmap text.month-name,
.heatmap text.calendar-heatmap-legend-text,
.heatmap text.day-initial {
  font-size: 10px;
  fill: inherit;
  font-family: Helvetica, arial, sans-serif;
}
.heatmap rect.day-cell:hover {
  stroke: #555555;
  stroke-width: 1px;
}
